...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { description: @day.description, weekday: @day.weekday, year: @day.year } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { description: @day.description, weekday: @day.weekday, year: @day.year } }
